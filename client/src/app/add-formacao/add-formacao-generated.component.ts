/*
  ...
  Modify add-formacao.component.ts instead.
*/
...
export class AddFormacaoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.projetoNew.createFormacao(null, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Formacao!` });
    });
  }
}
