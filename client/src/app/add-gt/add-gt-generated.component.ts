/*
  ...
  Modify add-gt.component.ts instead.
*/
...
export class AddGtGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.projetoNew.createGt(null, event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Gt!` });
    });
  }
}
