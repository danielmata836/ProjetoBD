/*
  ...
  Modify add-pessoa.component.ts instead.
*/
...
export class AddPessoaGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  form0Submit(event: any) {
    this.projetoNew.createPessoa(null, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Pessoa!` });
    });
  }
}
