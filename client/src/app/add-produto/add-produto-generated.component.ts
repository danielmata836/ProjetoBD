/*
  ...
  Modify add-produto.component.ts instead.
*/
...
export class AddProdutoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.projetoNew.createProduto(null, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Produto!` });
    });
  }
}
