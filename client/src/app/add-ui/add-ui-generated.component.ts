/*
  ...
  Modify add-ui.component.ts instead.
*/
...
export class AddUiGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.projetoNew.createUi(null, event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Ui!` });
    });
  }
}
