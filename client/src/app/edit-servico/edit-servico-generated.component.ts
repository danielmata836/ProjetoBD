/*
  ...
  Modify edit-servico.component.ts instead.
*/
...
export class EditServicoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.projetoNew.getServicoByindexServicos(null, this.parameters.index_servicos)
  ...
  form0Submit(event: any) {
    this.projetoNew.updateServico(null, this.parameters.index_servicos, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
