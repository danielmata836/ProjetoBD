/*
  ...
  Modify requisitar-servico.component.ts instead.
*/
...
export class RequisitarServicoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.projetoNew.createServico(null, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Servico!` });
    });
  }
}
